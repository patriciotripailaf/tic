...
<html>
    ...
    <body class="fixed-left">
        ...
        <!-- Jquery-Ui -->
        <script src="<?php echo base_url(); ?>light/assets/plugins/jquery-ui/jquery-ui.min.js"></script>

        <!-- BEGIN PAGE SCRIPTS -->
        <script src="<?php echo base_url(); ?>light/assets/plugins/moment/moment.js"></script>
        <script src='<?php echo base_url(); ?>light/assets/plugins/fullcalendar/dist/fullcalendar.min.js'></script>
        <script src="<?php echo base_url(); ?>light/assets/pages/jquery.fullcalendar.js"></script>
